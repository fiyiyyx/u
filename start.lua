...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " تويس"
SudosS = {1848546111}
...
type = 'inline',
data = {
{{text = 'ƚꪝᎥᥱ᥉ ƚᥱᥲ️꧑ 🇮🇶 . ',url="t.me/FF0CC"}},
}
}
...
reply_markup = reply_markup
t = "*✘اوامر اخرى .\n *  ٴ— — — — — — — — — — —  *\n- الالعاب الاحترافيه .\n- المجموعه .\n- الرابط .\n- اسمي .\n- ايديي .\n- مسح نقاطي .\n- نقاطي .\n- مسح رسائلي .\n- رسائلي .\n- مسح جهاتي .\n- مسح بالرد .\n- تفاعلي .\n- جهاتي .\n- مسح سحكاتي .\n- سحكاتي .\n- رتبتي .\n- معلوماتي .\n- المنشئ .\n- رفع المنشئ .\n- البايو/نبذتي .\n- التاريخ/الساعه .\n- رابط الحذف .\n- الالعاب .\n- منع بالرد .\n- منع .\n- تنظيف + عدد .\n- قائمه المنع .\n- مسح قائمه المنع .\n- مسح الاوامر المضافه .\n- الاوامر المضافه .\n- ترتيب الاوامر .\n- اضف امر .\n- حذف امر .\n- اضف رد .\n- حذف رد .\n- ردود المدير .\n- مسح ردود المدير .\n- الردود المتعدده .\n- مسح الردود المتعدده .\n- وضع عدد المسح +رقم .\n- مسح البوتات .\n- ٴall .\n- غنيلي، فلم ، متحركه ، رمزيه ، فيديو .\n- تغير رد المواطن ، المميز ، الادمن ، المدير ، المنشئ ، المنشئ الاساسي. المالك ، المطور .\n- حذف رد المواطن ، المميز ، الادمن ، المدير ، المنشئ المنشئ الاساسي ، المالك المطور .*"
...
{{text = '- تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "تويس"),data="delnamebot"}},
...
os.execute('curl -s https://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@raw.githubusercontent.com/SiKOOO/u/main/start.lua -o start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
...
if Text and Text:match('(%d+)/play_wheel') then
    ...
    {
    {text = '‹ ᥉Ꭵᥣ᥎ᥱ𝑟 ƚ𝖾ᥲ️𝗆 .',url="t.me/ff0cc"}, 
    },
    }
...
{
{text = 'اخفاء الاوامر 🚫', data = data.sender_user_id..'/delAmr'}, 
},
{
{text = '‹ ᥉Ꭵᥣ᥎ᥱ𝑟 ƚ𝖾ᥲ️𝗆 .', url="t.me/ff0cc"},
},
...
mony_list = {}
for k,v in pairs(bank_users) do
if redis:get(bot_id.."boob"..v) then
...
msalm = "✮ وسوينا لك حساب في بنك سلفر 🏦\n✮ وشحنالك 50 دولار 💸 هدية\n\n⇜ رقم حسابك ↢ ( `"..cccall.."` )\n⇜ نوع البطاقة ↢ ( "..ccctype.." )\n⇜ فلوسك ↢ ( 50 دولار 💸 )\n⇜ شخصيتك : طيبة 😇"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
━━━━━━━━━
✮︙ استثمار ↢ تستثمر فلوسك بدون خسارة
━━━━━━━━━
...
━━━━━━━━━
✮︙ توب الحراميه ↢ اكثر أشخاص زارفين
━━━━━━━━━
...
data = {
{
{text = 'ماستر', data = msg.sender.user_id..'/master'},{text = 'فيزا', data = msg.sender.user_id..'/visaa'},{text = 'كي كارد', data = msg.sender.user_id..'/express'},
},
{text = '‹ ᥉Ꭵᥣ᥎ᥱ𝑟 ƚ𝖾ᥲ️𝗆 .',url="t.me/ff0cc"}, 
}
}
...
if redis:sismember(bot_id.."booob",msg.sender.user_id) then
if redis:get(bot_id.."in_company:name:"..msg.sender.user_id) then
...
namfra = redis:get(bot_id.."namefram"..msg.sender.user_id)
...
if tonumber(msg.sender.user_id) == tonumber(1848546111) then 
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
bot.sendText(msg.chat_id,msg.id,"\n*⇜ سلفر ماعندها حساب بالبنك 🤣*","md",true)  
return false
end
...
redis:del(bot_id.."rotpa"..Remsg.sender.user_id)
redis:del(bot_id.."rddd"..Remsg.sender.user_id)
redis:del(bot_id.."rotpagrid"..Remsg.sender.user_id)
redis:del(bot_id.."rotpaid"..Remsg.sender.user_id)
...
bot.sendText(msg.chat_id,msg.id, "✮ حوالة صادرة من بنك سلفر\n\n⇜ المرسل : "..news.."\n⇜ الحساب رقم : `"..cccc.."`\n⇜ نوع البطاقة : "..uuuu.."\n⇜ المستلم : "..newss.."\n⇜ الحساب رقم : `"..text.."`\n⇜ نوع البطاقة : "..fsvhh.."\n⇜ خصمت 10% رسوم تحويل\n⇜ المبلغ : "..convert_mony.." دولار 💸","md",true)
bot.sendText(fsvhhh,0, "✮ حوالة واردة من بنك سلفر\n\n⇜ المرسل : "..news.."\n⇜ الحساب رقم : `"..cccc.."`\n⇜ نوع البطاقة : "..uuuu.."\n⇜ المبلغ : "..convert_mony.." دولار 💸","md",true)
redis:del(bot_id.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
redis:del(bot_id.."transn" .. msg.sender.user_id)
else
bot.sendText(msg.chat_id,msg.id, "⇜ مافيه حساب بنكي كذا","md",true)
...
return bot.sendText(msg.chat_id,msg.id, "⇜ مايمديك تزرفه فلوسه اقل من 200 دولار 💸","md",true)
end
...
local msrokid = redis:get(bot_id.."msrokid"..msg.chat_id..msg.sender.user_id)
local hrameid = redis:get(bot_id.."hrameid"..msg.chat_id..msg.sender.user_id)
local balcmsrok = redis:get(bot_id.."balcmsrok"..msg.chat_id..msg.sender.user_id) or 0
...
redis:del(bot_id.."msrokid" ..msg.chat_id..msg.sender.user_id) 
redis:del(bot_id.."hrameid" ..msg.chat_id..msg.sender.user_id) 
redis:del(bot_id.."balcmsrok" ..msg.chat_id..msg.sender.user_id)
redis:del(bot_id.."timehrame" ..msg.chat_id..msg.sender.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 1000000000 دولار 💸","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 200000000 دولار 💸","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 30000000 دولار 💸","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 1000000 دولار 💸","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 300000 دولار 💸","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 120000 دولار 💸","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 80000 دولار 💸","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 30000 دولار 💸","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 3000 دولار 💸","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "⇜ مايمديك تهجم فلوسك اقل من 100000 دولار 💸","md",true)
end
if tonumber(ballanceed) < 100000 then
return bot.sendText(msg.chat_id,msg.id, "⇜ مايمديك تهجم عليه فلوسه اقل من 100000 دولار 💸","md",true)
end
...
if not redis:get(bot_id.."roog1"..msg.sender.user_id) or not redis:get(bot_id.."rooga1"..msg.sender.user_id) then
bot.sendText(msg.chat_id,msg.id,"يوجد خطأ ","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⇜ ابشر فتحت السوق *").by,"md",true)
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⇜ ابشر قفلت السوق *").by,"md",true)
end
...
bot.sendAudio(msg.chat_id,msg.id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@ff0cc")
sleep(1)
...
if tonumber(coniss) > 100000 then
return bot.sendText(msg.chat_id,msg.id, "⇜ الحد الاعلى المسموح به هو 100,000 دولار \n✦","md",true)
end
if tonumber(coniss) < 999 then
return bot.sendText(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح به هو 1,000 دولار \n✦","md",true)
end
if redis:ttl(bot_id.."tabrotime" .. msg.sender.user_id) >=60 then
local hours = redis:ttl(bot_id.."tabrotime" .. msg.sender.user_id) / 60
return bot.sendText(msg.chat_id,msg.id,"⇜ يمديك تتبرع بعد "..math.floor(hours).." دقيقة","md",true)
...
tabr = math.random(1,#monyyy_list)
...
bot.sendText(msg.chat_id,msg.id,"*✘اوامر اخرى .\n *  ٴ— — — — — — — — — — —  *\n- الالعاب الاحترافيه .\n- المجموعه .\n- الرابط .\n- اسمي .\n- ايديي .\n- مسح نقاطي .\n- نقاطي .\n- مسح رسائلي .\n- رسائلي .\n- مسح جهاتي .\n- مسح بالرد .\n- تفاعلي .\n- جهاتي .\n- مسح سحكاتي .\n- سحكاتي .\n- رتبتي .\n- معلوماتي .\n- المنشئ .\n- رفع المنشئ .\n- البايو/نبذتي .\n- التاريخ/الساعه .\n- رابط الحذف .\n- الالعاب .\n- منع بالرد .\n- منع .\n- تنظيف + عدد .\n- قائمه المنع .\n- مسح قائمه المنع .\n- مسح الاوامر المضافه .\n- الاوامر المضافه .\n- ترتيب الاوامر .\n- اضف امر .\n- حذف امر .\n- اضف رد .\n- حذف رد .\n- ردود المدير .\n- مسح الردود المتعدده .\n- الردود المتعدده .\n- وضع عدد المسح +رقم .\n- ٴall .\n- غنيلي،فلم، متحركه، فيديو، رمزيه،انمي،ريمكس،شعر،ميمز،راب .\n- مسح ردود المدير .\n- تغير رد المواطن.المميز.الادمن.المدير.المنشئ.المنشئ الاساسي.المالك.المطو  .\n- حذف رد المواطن.المميز.الادمن.المدير.المنشئ.المنشئ الاساسي.المالك.المطور .*","md",true)
...
name = string.gsub(name,"هادئ","تويسي")
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "تويس"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "تويس"),"اني لقميل "..(redis:get(bot_id..":namebot") or "تويس"),(redis:get(bot_id..":namebot") or "تويس").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == "اكلك" or text == (redis:get(bot_id..":namebot") or "تويس") then
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = 'ƚꪝᎥᥱ᥉ ƚᥱᥲ️꧑ 🇮🇶 . ',url="https://t.me/FF0CC"}},
}
}
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⇜ ابشر فعلت زوجني *").by,"md",true)
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*⇜ ابشر عطلت زوجني *").by,"md",true)
end
...
local Text = "*✘𝘞𝘌𝘓𝘤𝘰𝘮𝘦 𝘵𝘰 ƚꪝᎥᥱ᥉ ƚᥱᥲ️꧑  .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '-  ƚꪝᎥᥱ᥉ ƚᥱᥲ️꧑ .',url="https://t.me/FF0CC"}},
{{text = '- Ꭵꪀf᥆ ƚꪝᎥᥱ᥉ .',url="https://t.me/FF0CC"}},
{{text = '- ძ᥎ᥱᥣ᥆ρᥱ𝒓 ᥉ᥲ️Ꭵ𝚔᥆ .',url="https://t.me/E_H_T"}},
